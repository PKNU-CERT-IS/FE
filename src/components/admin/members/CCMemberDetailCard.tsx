...
export default function CCMemberDetailCard({
  ...
  const [isOpenKickMmodal, setIsOpenKickModal] = useState<boolean>(false);
          ...
          <div className="relative pb-3 flex flex-col space-y-1.5 p-6">
            <div className="flex items-center gap-2">
              <button
                ...
                className="absolute top-4 right-4 text-md text-gray-400 hover:text-gray-600 flex items-center justify-center cursor-pointer"
              >
                <X />
              </button>
              <div>
          ...
          <div className="space-y-4 p-6 pt-0">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                {selectedMember.currentStudies.map((study, item) => (
                  <div
                    key={item}
                ...
                {selectedMember.currentProjects.map((project, item) => (
                  <div
                    key={item}
