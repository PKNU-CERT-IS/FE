...
import AttachedFilesDownload from "../CCAttachedFilesDownload";
...
const mockFiles: AttachedFile[] = [
  {
    ...
    category: "document",
    attachedUrl: "/api/files/download/plan.pdf",
  ...
  },
  {
    ...
    type: "video/mp4",
    category: "video",
    attachedUrl: "/api/files/download/demo.mp4",
  ...
  },
  {
    ...
    category: "archive",
    attachedUrl: "/api/files/download/source.zip",
  ...
  },
  {
    ...
    type: "text/csv",
    category: "dataset",
    attachedUrl: "/api/files/download/dataset.csv",
  ...
  },
  {
    ...
    type: "image/png",
    category: "image",
    attachedUrl: "/api/files/download/architecture.png",
